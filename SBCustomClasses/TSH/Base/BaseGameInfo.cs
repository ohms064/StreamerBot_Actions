...
namespace SBCustomClasses.TSH.Base
{
    ...
    {
        [JsonProperty("smashgg_game_id")]
        public long SmashggGameId { get; set; }
        ...
        [JsonProperty("challonge_game_id")]
        public long ChallongeGameId { get; set; }

        public string GetCodename(string characterName)
        {
            var result = "";

            if (CharacterToCodename.TryGetValue(characterName, out var value))
            {
    ...
    {
        [JsonProperty("smashgg_name")]
        public string SmashggName { get; set; }
    ...
    public partial class BaseGameInfo
    {
        public static BaseGameInfo FromJson(string json) => JsonConvert.DeserializeObject<BaseGameInfo>(json, Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this BaseGameInfo self) => JsonConvert.SerializeObject(self, Converter.Settings);
    }
