...
namespace SBCustomClasses.TSH.MatchList
{
    ...
    public partial class MatchListData
    {
        ...
        public List<List<Entrant>> Entrants { get; set; } = new List<List<Entrant>>();
    ...
    public partial class MatchListData
    {
        public static MatchListData FromJson(string json) => JsonConvert.DeserializeObject<MatchListData>(json, Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this MatchListData self) => JsonConvert.SerializeObject(self, (JsonSerializerSettings) Converter.Settings);
    }
