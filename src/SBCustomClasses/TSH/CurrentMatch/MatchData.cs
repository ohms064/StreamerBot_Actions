...
namespace SBCustomClasses.TSH.CurrentMatch
{
    ...
    {
        [JsonProperty("strikedBy")] public List<List<object>> StrikedBy { get; set; } = new List<List<object>>();

        [JsonProperty("ruleset")] public List<string> Ruleset { get; set; } = new List<string>();

        [JsonProperty("team2score")] public long Team2Score { get; set; }
        ...
        [JsonProperty("currPlayer")] public long CurrPlayer { get; set; }

        [JsonProperty("p2_name")] public string P2Name { get; set; } = "";

        [JsonProperty("top_n")] public long TopN { get; set; }

        [JsonProperty("stream")] public string Stream { get; set; } = "";

        [JsonProperty("stage_strike")] public List<string> StageStrike { get; set; } = new List<string>();

        [JsonProperty("round_name")] public string RoundName { get; set; } = "";

        [JsonProperty("team2losers")] public bool Team2Losers { get; set; }

        [JsonProperty("station")] public string Station { get; set; } = "";

        [JsonProperty("entrants")] public List<List<Entrant>> Entrants { get; set; }

        [JsonProperty("id")] public long Id { get; set; }

        [JsonProperty("tournament_phase")] public string TournamentPhase { get; set; } = "";

        [JsonProperty("team1losers")] public bool Team1Losers { get; set; }

        [JsonProperty("team1score")] public long Team1Score { get; set; }
    }
    ...
    public partial class Entrant
    {
        ...
        [JsonProperty("id")] public List<object> Id { get; set; } = new List<object>();
    }

    public partial class MatchData
    {
        public static MatchData FromJson(string json)
        {
            return JsonConvert.DeserializeObject<MatchData>(json, Converter.Settings);
        }
    }

    public static class Serialize
    {
        public static string ToJson(this MatchData self)
        {
